...
\input{config/thesis-config}                 % your name, title, committee, ...
...
\input{chapters/section-style-example}
%% ==== END OF CHAPTERS =======================================================

\ThesisBibliography

%% ==== APPENDICES (delete this block if you have none) =======================
%%  One \input line per appendix file.  The appendices letter themselves from
%%  how many there are: exactly one prints a bare "APPENDIX" and numbers its
%%  tables, figures and equations 1, 2, 3; two or more print "APPENDIX A",
%%  "APPENDIX B", ... and number them A.1, B.1, and so on.
\ThesisAppendices
\input{chapters/section-style-appendix}
\input{chapters/section-style-appendix}
%% ============================================================================
