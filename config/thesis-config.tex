...
\ThesisSetup{
  ...
  output-name    = {TTU-Example-Thesis},
  ...
  structure      = {sections},         % allowed: chapters  or  sections
  ...
  title          = {Texas Tech University Thesis Template},
  %% Your name --------------------------------------------------------------
  ...
  middle-initial = {M},                % just the letter, no period; or empty
  last-name      = {Lastname},
  credentials    = {B.S.},       % prior degrees; or leave empty
  %% Degree and department --------------------------------------------------
  department     = {Department},  % e.g. Department of Mechanical Engineering
  degree         = {Master of Science}, % Master of Science, etc.
  %% Committee --------------------------------------------------------------
