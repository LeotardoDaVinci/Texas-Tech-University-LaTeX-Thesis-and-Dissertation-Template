...
% HOW TO: a top-level division starts with \section{...}. It begins a new page
% and is numbered automatically ("1. INTRODUCTION").
...
numbered section: it starts a new page, it is listed in the table of contents,
and it is the only level that resets the figure, table and equation numbers.
...
literature~\cite{upper1974}, which is inexplicably peer-reviewed. For a more 
